    ...
    <Box className={classes.landingContent}>
      ...
      <Paper className={classes.fullSection}>
        <Box className={classes.landingSection} pt="1px" pb="15px"><h3>About the VICC Fusion Curation Interface</h3>
          ...
          <Box mt="15px"><Typography>This educational web tool provides a user interface supporting gene fusion curation. This web tool is primarily an educational resource to demonstrate the computable structure and associated nomenclature for gene fusions constructed in the application.</Typography></Box>
        </Box>
      </Paper>
